...
app.add_middleware(
    CORSMiddleware,
    allow_origins=allowed_origins,  # Allow all origins on default, adjust as needed
...
def initialize_pipeline():
    global pipe
    if pipe is None:
        print("Loading the FLUX.1-schnell pipeline...")
...
@app.get('/')
def read_root():
    return {"message": "Welcome to the FLUX.1-schnell image generation API!"}
